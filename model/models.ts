...
export * from './revealedData';
export * from './updateAliasRequest';
export * from './updateAliasRequestData';
...
import { UpdateAliasRequest } from './updateAliasRequest';
import { UpdateAliasRequestData } from './updateAliasRequestData';
...
let typeMap: {[index: string]: any} = {
    ...
    "UpdateAliasRequestData": UpdateAliasRequestData,
}
