...
export class CreateAliasesRequestNew {
    /**
    ...
    */
    'storage'?: CreateAliasesRequestNew.StorageEnum;
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "storage",
            "baseName": "storage",
            "type": "CreateAliasesRequestNew.StorageEnum"
        },
        {
            "name": "value",
            "baseName": "value",
    ...
    static getAttributeTypeMap() {
        return CreateAliasesRequestNew.attributeTypeMap;
    }
}

export namespace CreateAliasesRequestNew {
